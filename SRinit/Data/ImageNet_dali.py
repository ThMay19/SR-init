...
class ImageNetDali:
    def __init__(self):
        ...
        self.train_loader = get_imagenet_iter_dali(
            type='train', # /public/MountData/dataset/ImageNet50/ or /public/xjy/cv/data/imagenet/
            image_dir='/public/xjy/cv/data/imagenet/', # You should construct the ImageNet50 dataset according to the content of the supplementary materials
