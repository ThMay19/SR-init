...
class CIFAR100:
    def __init__(self):
        ...
        self.train_loader = torch.utils.data.DataLoader(
            train_dataset, batch_size=args.batch_size, shuffle=True, num_workers=20, pin_memory=True
        )
        ...
        self.val_loader = torch.utils.data.DataLoader(
            test_dataset, batch_size=args.batch_size, shuffle=False, num_workers=20, pin_memory=True
        )
...
class CIFAR100_224:
    ...
    def __init__(self):
        super(CIFAR100_224, self).__init__()
