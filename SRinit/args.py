...
parser.add_argument("--set", help="name of dataset", type=str, default='cifar100', choices=["cifar10", "cifar100", 'imagenet_dali', 'ImageNet16-120'])
...
parser.add_argument("--arch", metavar="ARCH", default='resnet56', help="model architecture")
...
parser.add_argument('--lr_type', default='step', type=str, help='learning rate decay schedule')
parser.add_argument('--location', type=str, default='1', help='save the different finetune model')
