...
parser.add_argument("--gpu", default='1', type=int, help="Which GPU to use for training")
...
def replace_layer_initialization(path):
    ...
    if args.evaluate:
        ...
        torch.save(acc1, "./result/baseline/best_acc_{}_on_{}.pt".format(args.arch, args.set))
...
'''
python get_estimation_accuracy.py --arch resnet56 --set cifar10 --num_classes 10 --random_seed 1 --evaluate --gpu 1
python get_estimation_accuracy.py --arch resnet56 --set cifar100 --num_classes 100 --random_seed 1 --evaluate --gpu 1
python get_estimation_accuracy.py --arch ResNet50 --set imagenet_dali --num_classes 1000 --random_seed 1 --evaluate --gpu 1
'''
